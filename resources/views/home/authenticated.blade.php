<x-app>
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
            <!-- Libros destacados - Ocupa 2 columnas -->
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-5">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                            @foreach($featuredBooks->take(6) as $book)
                                <div class="bg-gray-50 rounded-lg border border-gray-200 hover:shadow-md transition-shadow p-4">
                                    <div class="flex items-start justify-between mb-2">
                                        <h3 class="text-base font-semibold text-gray-900 line-clamp-2 flex-1 mr-2">{{ $book->titulo }}</h3>
                                        @if($book->is_free)
                                        ...
                                        @else
                                            <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800 shrink-0">
                                    ...
                                    <p class="text-xs text-gray-500 line-clamp-2 mb-3">{{ \Illuminate\Support\Str::limit($book->sinopsis, 80) }}</p>
                                    
                                    <a href="{{ route('books.show', $book->slug) }}" 
                                       class="w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-xs px-3 py-2 text-center focus:outline-none block">
                                        Ver detalles
                                    </a>
                                </div>
                            @endforeach
            ...
            <!-- Sidebar derecho - Categorías y Autores -->
            <div class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <a href="{{ route('catalog.index') }}" 
                   class="bg-gray-50 hover:bg-blue-50 border border-gray-200 hover:border-blue-300 rounded-lg p-5 text-center transition-all shadow-sm hover:shadow-md">
                    <i class="fa-solid fa-book-open text-3xl mb-3 text-blue-600"></i>
                    <p class="font-semibold text-gray-900">Explorar Catálogo</p>
                </a>
                <a href="{{ route('dashboard') }}" 
                   class="bg-gray-50 hover:bg-blue-50 border border-gray-200 hover:border-blue-300 rounded-lg p-5 text-center transition-all shadow-sm hover:shadow-md">
                    <i class="fa-solid fa-gauge text-3xl mb-3 text-blue-600"></i>
                    <p class="font-semibold text-gray-900">Mi Dashboard</p>
                </a>
                <a href="{{ route('catalog.index', ['search' => '']) }}" 
                   class="bg-gray-50 hover:bg-blue-50 border border-gray-200 hover:border-blue-300 rounded-lg p-5 text-center transition-all shadow-sm hover:shadow-md">
                    <i class="fa-solid fa-search text-3xl mb-3 text-blue-600"></i>
